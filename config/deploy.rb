  ...
  set :application,     "whackahole"
  set :repo_url,        "git@github.com:dschmura/whackahole.git"
  set :user,            'deployer'
  ...
  set :deploy_to,       "/home/#{fetch(:user)}/apps/whackahole"
  set :puma_bind,       "unix://#{shared_path}/tmp/sockets/whackahole-puma.sock"
  ...
  namespace :deploy do
    ...
    #       execute("ln -nfs /home/deployer/apps/whackahole/current/config/nginx.conf /etc/nginx/sites-enabled/whackahole && rm /etc/nginx/sites-enabled/default")
    #     end
    #   end
    # end
